...
#/net/work/bin/scripts/mass_store/archAC/archive.py HRT/RRUN/NetCDF $cwd/RRUN nc /RAF/$YEAR/$NUM stroble@ucar.edu
/net/work/bin/scripts/mass_store/archAC/archive.py HRT/XRUN/NetCDF $cwd/XRUN nc /RAF/$YEAR/$NUM stroble@ucar.edu
