...
my $dataset_id = "176.002";
my $dirNC = "/RAF/1986/811/HRT/NetCDF";
my $filter = "";
...
for (my $i = 0; $i <= $#files; $i++) {
	...
	if (($#ncFiles == 0) && ($ncFiles[0] =~ /(\d\d)(\d\d)(\d\d).(\d\d)(\d\d)(\d\d).(\d\d)(\d\d)(\d\d)/)) {
		...
		$mysqlFile->setBeginDate(1900 + $1, $2, $3, $4, $5, $6);
		$mysqlFile->setEndDate(1900 + $1, $2, $3, $7, $8, $9);
