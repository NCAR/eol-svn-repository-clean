...
do
    ...
    ncatted -a FirstBin,A1DCR_RPI,c,s,"3" $file
    ncatted -a LastBin,A1DCR_RPI,c,s,"63" $file
    ...
    ncatted -a FirstBin,C1DCR_RPI,c,s,"3" $file
    ncatted -a LastBin,C1DCR_RPI,c,s,"63" $file
    ...
    ncatted -a FirstBin,A1DCA_RPI,c,s,"3" $file
    ncatted -a LastBin,A1DCA_RPI,c,s,"63" $file
    ...
    ncatted -a FirstBin,C1DCA_RPI,c,s,"3" $file
    ncatted -a LastBin,C1DCA_RPI,c,s,"63" $file
