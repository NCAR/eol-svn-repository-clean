 ...
 */
public class QCFiosp extends AbstractIOServiceProvider {
...
public boolean isValidFile(RandomAccessFile infile) throws IOException {
      ...
      return (test.substring(802, 803).equals("/") && test.substring(805, 806).equals("/") &&
            test.substring(811, 812).equals(":") && test.substring(814, 815).equals(":") &&
            (fileType.equals("qcf")));
   }
  ...
  */
   public void build(RandomAccessFile infile, Group.Builder rootGroup, CancelTask cancelTask)
      ...
      try {
         ...
         e.printStackTrace();
         throw new IOException("QCFiosp: Parse exception occurred.");
      } catch (ConversionException e) {
         e.printStackTrace();
         throw new IOException("QCFiosp: Invalid conversion attempted.");
      }
...
/**
  ...
  */
   protected static void usage(int ret) {
      System.err.println("usage: QCFiosp\n" +
...
// Parse arguments on command line
      Getopt g = new Getopt("QCFiosp", args, "i:o:u:p:d:");
      ...
      ucar.nc2.NetcdfFiles.registerIOProvider(QCFiosp.class);
      ncfile = null;
