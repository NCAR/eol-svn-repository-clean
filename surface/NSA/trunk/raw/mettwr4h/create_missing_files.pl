...
$hash{C1}{in_dir} = "/net/work/CEOP/version2/data_processing/other/NSA/raw/mettwr4h";

$hash{C2}{lat} = 70.4718 ;
$hash{C2}{lon} = -157.407 ;
$hash{C2}{alt} = 20 ;
$hash{C2}{name} = "mettwr2h";
$hash{C2}{in_dir} = "/net/work/CEOP/version2/data_processing/other/NSA/raw/mettwr2h";
