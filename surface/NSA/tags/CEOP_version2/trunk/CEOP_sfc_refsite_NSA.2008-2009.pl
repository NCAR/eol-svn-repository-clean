...
# rev 20 Jan 2010, ss
#	parameter names changed ~ 9/2008 so s/w change to
#	reflect new parameter names	
#--------------------------------------------------------------------------------------
...
#--------------------------------------------------------------------------------------
my (@gndrad_fields, @mettwr2h_fields, @mettwr4h_fields, @skyrad_fields, @met);
my ($U_wind, $V_wind);
...
# met variable names
push (@met_fields, "time_offset");
push (@met_fields, "atmos_pressure");
push (@met_fields, "qc_atmos_pressure");
push (@met_fields, "wspd_vec_mean");
push (@met_fields, "qc_wspd_vec_mean");
push (@met_fields, "wdir_vec_mean");
push (@met_fields, "qc_wdir_vec_mean");
push (@met_fields, "temp_mean");
push (@met_fields, "qc_temp_mean");
push (@met_fields, "dew_point_mean");
push (@met_fields, "qc_dew_point_mean");
push (@met_fields, "rh_mean");
push (@met_fields, "qc_rh_mean");
push (@met_fields, "pws_precip_rate_mean_1min");
push (@met_fields, "qc_pws_precip_rate_mean_1min");
...
push (@skyrad_fields, "down_long_hemisp1");
push (@skyrad_fields, "qc_down_long_hemisp1");
# 
my @sfc_parameter_list;
push(@sfc_parameter_list, "AtmPress");		# atmospheric pressure mettwr2h, mettwr4h
push(@sfc_parameter_list, "atmos_pressure");    # atmospheric pressure met
push(@sfc_parameter_list, "T2m_AVG");		# temperature mettwr2h
push(@sfc_parameter_list, "T2M_AVG");		# temperature mettwr4h
push(@sfc_parameter_list, "temp_mean");		# temperature met 
push(@sfc_parameter_list, "DP2m_AVG");		# dew point mettwr2h
push(@sfc_parameter_list, "DP2M_AVG");		# dew point mettwr4h
push(@sfc_parameter_list, "dew_point_mean");	# dew point met 
push(@sfc_parameter_list, "RH2m_AVG");		# relative humidity mettwr2h
push(@sfc_parameter_list, "RH2M_AVG");		# relative humidity mettwr4h
push(@sfc_parameter_list, "rh_mean");		# relative humidity met 
...
push(@sfc_parameter_list, "wspd_vec_mean");	# wind speed met 
...
push(@sfc_parameter_list, "wdir_vec_mean");	# wind direction met 
...
$param_index{'C1'}{'atmos_pressure'} = 0;
$param_index{'C2'}{'atmos_pressure'} = 0;
$param_index{'C1'}{'T2M_AVG'} = 1;
$param_index{'C2'}{'T2m_AVG'} = 1;
$param_index{'C1'}{'temp_mean'} = 1;
$param_index{'C2'}{'temp_mean'} = 1;
$param_index{'C1'}{'DP2M_AVG'} = 2;
$param_index{'C2'}{'DP2m_AVG'} = 2;
$param_index{'C1'}{'dew_point_mean'} = 2;
$param_index{'C2'}{'dew_point_mean'} = 2;
$param_index{'C1'}{'RH2M_AVG'} = 3;
$param_index{'C2'}{'RH2m_AVG'} = 3;
$param_index{'C1'}{'rh_mean'} = 3;
$param_index{'C2'}{'rh_mean'} = 3;
$param_index{'C1'}{'spec_hum'} = 4;
$param_index{'C2'}{'spec_hum'} = 4;
$param_index{'C1'}{'WS10M_U_WVT'} = 5;
$param_index{'C2'}{'WinSpeed_U_WVT'} = 5;
$param_index{'C1'}{'wspd_vec_mean'} = 5;
$param_index{'C2'}{'wspd_vec_mean'} = 5;
$param_index{'C1'}{'WD10M_DU_WVT'} = 6;
$param_index{'C2'}{'WinDir_DU_WVT'} = 6;
$param_index{'C1'}{'wdir_vec_mean'} = 6;
$param_index{'C2'}{'wdir_vec_mean'} = 6;
...
$param_index{'C1'}{'pws_precip_rate_mean_1min'} = 9;
$param_index{'C2'}{'pws_precip_rate_mean_1min'} = 9;
...
$param_index{'C1'}{'down_long_hemisp1'} = 13;
$param_index{'C2'}{'down_long_hemisp1'} = 13;
...
%filename_pattern = (
    ...
    "met" => 'nsamet([CE]\d{1,3}).b1.(\d{4})(\d{2})(\d{2})\.(\d{2})(\d{2})',
...
push(@dqr_fname, "raw/NSA_MET_flagging_2008_2009.txt");
