#!/usr/bin/perl -I/net/work/CEOP/version2/data_processing/other/NSA
...
$command = "./print_column.converted.pl -i $converted_fname -n $category -h $height >> $converted_out_fname";
system($command);
