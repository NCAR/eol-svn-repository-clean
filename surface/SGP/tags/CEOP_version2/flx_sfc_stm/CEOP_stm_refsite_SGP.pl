...
# rev 25 Apr 10, ds
#   code for not putting out missing levels commented out, to run with version2
#--------------------------------------------------------------------------------------
...
$project_begin_date = 20050101;     # version2
...
open (OUTFILE_STM, ">./out/$outfile4") || die "Can't open $outfile4";
						...
						if ($platform eq "swats") { 
							if ($obsName eq "time_offset") {
								...
								do {
									...
									if ($numObs == 0) {	
	   	                				$thisNumDepths = $#line_value - 1;          # has semi-colon at end since only one line of values
									} else {
									...
									if ($numDepths != $thisNumDepths) {
										print "x: Different number of depths in the $obsName line; expecting $numDepths, but have $thisNumDepths\n";
										print "x: obs are indexed from 0 - $thisNumObs for $obsName in $filename\n";
			        	        		print "x: this array of $obsName is indexed from 0 to $numDepths; the values are: @{$obsName}\n\n";
										print "x: line value = @line_value\n";
									}
									die "x: Different number of depths in the $obsName line; expecting $numDepths, but have $thisNumDepths\n" if ($numDepths != $thisNumDepths);
...
# and grouped them into files which are read by the utility 
# program--"prepare_DQR-SWATS.pl".
# The final product for the DQR is in the proper form to be 
...
sub get_flag
{
    ...
    #---------------------------------------------------------------------------
    # following section fixes flags according to DQRs for SWATS data
    #---------------------------------------------------------------------------
    # E1
    #---------------------------------------------------------------------------
    if ($id eq "E1") {
        if ($var eq "watcont_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20050114.0630 && $datetime <= 20050123.2330) {
                   $new_flag = "D";
               }
            }
            if ($ht == -0.15) {
               ...
               if ($datetime >= 20080529.0000 && $datetime <= 20081231.2359) {
                   $new_flag = "B";
               }
            }
        }
        if ($var eq "tsoil_W") {
            if ($ht == -1.25) {
               if ($datetime >= 20090320.0000 && $datetime <= 20091014.1620) {
                   $new_flag = "D";
               }
            }
            if ($ht == -0.60) {
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20070503.0000 && $datetime <= 20070515.2100) {
                   $new_flag = "D";
               }
            }
            if ($ht == -0.60) {
        ...
        if ($var eq "tsoil_W") {
            if ($ht == -0.25) {
               if ($datetime >= 20081028.2200 && $datetime <= 20090204.2045) {
                   $new_flag = "D";
               }
               if ($datetime >= 20081028.2200 && $datetime <= 20090204.2045) {
                   $new_flag = "D";
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20070828.0210 && $datetime <= 20071106.1700) {
                   $new_flag = "D";
               }
               if ($datetime >= 20070828.2100 && $datetime <= 20071106.1700) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070828.0210 && $datetime <= 20071106.1700) {
                   $new_flag = "B";
               }
               if ($datetime >= 20060712.0000 && $datetime <= 20060815.1800) {
                   $new_flag = "B";
               }
            }
            if ($ht == -0.60) {
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($datetime >= 20081022.0800 && $datetime <= 20081105.2200) {
               $new_flag = "D";
            }
            if ($ht == -0.05) {
               if ($datetime >= 20050904.2000 && $datetime <= 20081231.2359) {
                   $new_flag = "B";
               }
            }
            if ($ht == -1.75) {
               if ($datetime >= 20020912.1400 && $datetime <= 20081231.2359) {
                   $new_flag = "B";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -1.25) {
               if ($datetime >= 20020621.0900 && $datetime <= 20081211.2100) {
                   $new_flag = "D";
               }
               if ($datetime >= 20020621.0900 && $datetime <= 20081211.2100) {
                   $new_flag = "B";
            ...
            if ($ht == -0.15) {
               if ($datetime >= 20070810.0000 && $datetime <= 20081211.2000) {
                   $new_flag = "D";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
           if ($datetime >= 20071220.0000 && $datetime <= 20081111.1500) {
               $new_flag = "D";
           }
            if ($ht == -0.05) {
               if ($datetime >= 20071220.0000 && $datetime <= 20081111.1500) {
            ...
            if ($ht == -1.25) {
               if ($datetime >= 20050817.0000 && $datetime <= 20081111.1500) {
                   $new_flag = "B";
               }
            }
            if ($ht == -0.60) {
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20050106.1800 && $datetime <= 20050120.1730) {
                   $new_flag = "B";
               }
            }
            if ($ht == -1.25) {
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
        	if ($datetime >= 20070623.1200 && $datetime <= 20070726.1900) {
            	$new_flag = "B";
        	}
            if ($ht == -1.75) {
               if ($datetime >= 20010817.2200 && $datetime <= 20081231.2359) {
                   $new_flag = "D";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
        	if ($datetime >= 20030625.1900 && $datetime <= 20081130.2300) {
            	$new_flag = "B";
        	}
        }
        if ($var eq "tsoil_W") {
        	if ($datetime >= 20080901.0000 && $datetime <= 20090226.1545) {
            	$new_flag = "D";
        	}
        }
    #---------------------------------------------------------------------------
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($datetime >= 20080507.2000 && $datetime <= 20081104.2000) {
                $new_flag = "B";
            }
		}
    #---------------------------------------------------------------------------
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -0.35) {
               if ($datetime >= 19990720.1700 && $datetime <= 20081231.2359) {
                   $new_flag = "D";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -1.25) {
               if ($datetime >= 20060424.1600 && $datetime <= 20060601.1600) {
                   $new_flag = "D";
               }
            }
            if ($ht == -0.60) {
    ...
    if ($id eq "E1") {
        if ($var eq "watcont_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20080626.0300 && $datetime <= 20080626.0300) {
                   $new_flag = "B";
               }
            }
        }
        if ($var eq "tsoil_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20080707.2100 && $datetime <= 20080707.2100) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080707.1800 && $datetime <= 20080707.1900) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080626.0300 && $datetime <= 20080626.0500) {
                   $new_flag = "B";
               }
            }
            if ($ht == -1.25) {
               if ($datetime >= 20080705.1200 && $datetime <= 20080708.1900) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080626.0300 && $datetime <= 20080626.0500) {
                   $new_flag = "B";
            ...
            if ($ht == -0.85) {
               if ($datetime >= 20050101.0000 && $datetime <= 20091231.2300) {
                   $new_flag = "B";
               }
            }
            if ($ht == -1.75) {
            ...
            if ($ht == -0.35) {
               if ($datetime >= 20080707.2000 && $datetime <= 20080708.0400) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080626.0300 && $datetime <= 20080626.0500) {
                   $new_flag = "B";
            ...
            if ($ht == -0.25) {
               if ($datetime >= 20080707.2000 && $datetime <= 20080707.2000) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080626.0300 && $datetime <= 20080626.0500) {
                   $new_flag = "B";
            ...
            if ($ht == -0.15) {
               if ($datetime >= 20091009.2200 && $datetime <= 20091010.1000) {
                   $new_flag = "B";
               }
               if ($datetime >= 20090819.0700 && $datetime <= 20091009.1600) {
                   $new_flag = "B";
               }
               if ($datetime >= 20090217.2300 && $datetime <= 20090810.0700) {
                   $new_flag = "B";
               }
               if ($datetime >= 20090212.2100 && $datetime <= 20090214.0400) {
                   $new_flag = "B";
               }
               if ($datetime >= 20090211.1200 && $datetime <= 20090212.1500) {
                   $new_flag = "B";
               }
               if ($datetime >= 20090210.0000 && $datetime <= 20090210.1200) {
                   $new_flag = "B";
               }
               if ($datetime >= 20081031.0200 && $datetime <= 20081109.1200) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080729.0600 && $datetime <= 20081027.1300) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080719.0500 && $datetime <= 20080725.1500) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080715.0100 && $datetime <= 20080715.0400) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080714.0700 && $datetime <= 20080714.0900) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080711.0500 && $datetime <= 20080712.1100) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080621.1300 && $datetime <= 20080707.2000) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080618.0900 && $datetime <= 20080620.0200) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080616.2200 && $datetime <= 20080616.2200) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080530.0900 && $datetime <= 20080616.1600) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080529.1300 && $datetime <= 20080529.1300) {
                   $new_flag = "B";
               }
               if ($datetime >= 20080529.0400 && $datetime <= 20080529.0400) {
                   $new_flag = "B";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20070620.0600 && $datetime <= 20070822.1300) {
                   $new_flag = "B";
               }
               if ($datetime >= 20060826.0100 && $datetime <= 20070515.1900) {
                   $new_flag = "B";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20080912.2000 && $datetime <= 20091231.2330) {
                   $new_flag = "D";
               }
               if ($datetime >= 20070119.2200 && $datetime <= 20070119.2300) {
                   $new_flag = "B";
               }
            }
            if ($ht == -0.60) {
               if ($datetime >= 20060707.1300 && $datetime <= 20060707.1300) {
                   $new_flag = "B";
               }
               if ($datetime >= 20060707.1000 && $datetime <= 20060707.1000) {
                   $new_flag = "B";
               }
            }
            if ($ht == -0.35) {
               if ($datetime >= 20060707.0400 && $datetime <= 20060707.0400) {
                   $new_flag = "B";
               }
               if ($datetime >= 20060410.1600 && $datetime <= 20060410.1600) {
                   $new_flag = "B";
               }
            }
            if ($ht == -0.25) {
            ...
            if ($ht == -0.15) {
               ...
               if ($datetime >= 20080706.0900 && $datetime <= 20080711.0700) {
                   $new_flag = "B";
               }
            }
        }
        if ($var eq "tsoil_W") {
            if ($ht == -0.15) {
               if ($datetime >= 20080706.1500 && $datetime <= 20080723.1300) {
                   $new_flag = "D";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20051209.1200 && $datetime <= 20051209.2200) {
                   $new_flag = "B";
               }
               if ($datetime >= 20050118.1400 && $datetime <= 20050119.0600) {
                   $new_flag = "B";
               }
               if ($datetime >= 20050117.1600 && $datetime <= 20050118.0600) {
                   $new_flag = "B";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20050101.0000 && $datetime <= 20050501.0000) {
                   $new_flag = "B";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20090117.2200 && $datetime <= 20090118.0900) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070308.1700 && $datetime <= 20070308.1700) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070219.0500 && $datetime <= 20070219.1000) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070207.0400 && $datetime <= 20070207.0400) {
                   $new_flag = "B";
               }
               if ($datetime >= 20060323.1900 && $datetime <= 20060323.1900) {
                   $new_flag = "B";
               }
            }
        }
        if ($var eq "tsoil_W") {
            if ($ht == -1.75) {
               if ($datetime >= 20050105.1700 && $datetime <= 20050105.1700) {
                   $new_flag = "B";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20050817.2000 && $datetime <= 20050817.2000) {
                   $new_flag = "B";
               }
               if ($datetime >= 20050804.2000 && $datetime <= 20050804.2300) {
                   $new_flag = "B";
               }
            }
            if ($ht == -1.25) {
               if ($datetime >= 20050804.2300 && $datetime <= 20091231.2300) {
                   $new_flag = "B";
               }
            }
            if ($ht == -0.60) {
               if ($datetime >= 20051221.2200 && $datetime <= 20051221.2200) {
                   $new_flag = "B";
               }
               if ($datetime >= 20050804.2000 && $datetime <= 20050804.2300) {
                   $new_flag = "B";
            ...
            if ($ht == -0.85) {
               if ($datetime >= 20050804.2000 && $datetime <= 20060720.1300) {
                   $new_flag = "B";
               }
            }
            if ($ht == -0.35) {
            ...
            if ($ht == -0.25) {
               ...
               if ($datetime >= 20050810.0200 && $datetime <= 20050810.0200) {
                   $new_flag = "B";
               }
               if ($datetime >= 20050804.2000 && $datetime <= 20050804.2300) {
                   $new_flag = "B";
            ...
            if ($ht == -0.15) {
               if ($datetime >= 20050815.0100 && $datetime <= 20050815.0100) {
                   $new_flag = "B";
               }
               if ($datetime >= 20050817.2000 && $datetime <= 20050817.2000) {
                   $new_flag = "B";
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -1.25) {
               if ($datetime >= 20060615.1900 && $datetime <= 20060615.2000) {
                   $new_flag = "B";
               }
            }
            if ($ht == -0.85) {
               if ($datetime >= 20060615.2200 && $datetime <= 20060615.2300) {
                   $new_flag = "B";
               }
            }
            if ($ht == -0.15) {
               if ($datetime >= 20060615.2000 && $datetime <= 20060615.2000) {
                   $new_flag = "B";
               }
            }
            if ($ht == -1.75) {
               if ($datetime >= 20061112.1500 && $datetime <= 20061112.1700) {
                   $new_flag = "B";
               }
               if ($datetime >= 20060616.0300 && $datetime <= 20060616.0300) {
                   $new_flag = "B";
               }
            }
            if ($ht == -0.35) {
               if ($datetime >= 20060616.0200 && $datetime <= 20060616.0200) {
                   $new_flag = "B";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            ...
            if ($ht == -0.60) {
               if ($datetime >= 20070710.2100 && $datetime <= 20070710.2100) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070714.2200 && $datetime <= 20070715.0000) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070516.0700 && $datetime <= 20070516.0700) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070513.1900 && $datetime <= 20070513.1900) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070512.2200 && $datetime <= 20070512.2200) {
                   $new_flag = "B";
               }
            }
            if ($ht == -0.85) {
               if ($datetime >= 20050106.1800 && $datetime <= 20050120.1600) {
                   $new_flag = "B";
               }
            }
        }
        if ($var eq "tsoil_W") {
            if ($ht == -0.25) {
               if ($datetime >= 20070501.1900 && $datetime <= 20070501.2000) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070318.1400 && $datetime <= 20070319.0300) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070313.1200 && $datetime <= 20070313.1200) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070301.0200 && $datetime <= 20070301.0200) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070228.1500 && $datetime <= 20070228.1500) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070127.1700 && $datetime <= 20070127.1700) {
                   $new_flag = "B";
               }
               if ($datetime >= 20070116.1100 && $datetime <= 20070116.1100) {
                   $new_flag = "B";
               }
               if ($datetime >= 20060801.0100 && $datetime <= 20060801.0300) {
                   $new_flag = "B";
               }
               if ($datetime >= 20051025.1000 && $datetime <= 20051025.1000) {
                   $new_flag = "B";
               }
               if ($datetime >= 20051020.1200 && $datetime <= 20051020.1200) {
                   $new_flag = "B";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -0.85) {
               if ($datetime >= 20060526.0700 && $datetime <= 20060526.0800) {
                   $new_flag = "B";
               }
            }
        }
        if ($var eq "tsoil_W") {
            if ($ht == -0.85) {
               if ($datetime >= 20070101.0000 && $datetime <= 20091231.2300) {
                   $new_flag = "B";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -1.25) {
               if ($datetime >= 20050209.1800 && $datetime <= 20050210.0000) {
                   $new_flag = "D";
               }
               if ($datetime >= 20060406.0900 && $datetime <= 20060406.1100) {
                   $new_flag = "D";
               }
               if ($datetime >= 20060224.1900 && $datetime <= 20060224.1900) {
                   $new_flag = "D";
               }
               if ($datetime >= 20060208.2300 && $datetime <= 20060214.2300) {
                   $new_flag = "D";
               }
               if ($datetime >= 20060101.2000 && $datetime <= 20060101.2100) {
                   $new_flag = "D";
               }
               if ($datetime >= 20050106.1400 && $datetime <= 20050126.1500) {
                   $new_flag = "D";
               }
            }
            if ($ht == -0.60) {
            ...
            if ($ht == -0.35) {
               ...
               if ($datetime >= 20060208.2300 && $datetime <= 20060214.2303) {
                   $new_flag = "D";
               }
               if ($datetime >= 20060101.2000 && $datetime <= 20060101.2100) {
                   $new_flag = "D";
        ...
        if ($var eq "tsoil_W") {
            if ($ht == -1.25) {
               if ($datetime >= 20080221.2200 && $datetime <= 20080221.2200) {
                   $new_flag = "B";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20070203.2200 && $datetime <= 20070223.0500) {
                   $new_flag = "D";
               }
               if ($datetime >= 20050118.1000 && $datetime <= 20050119.1200) {
                   $new_flag = "D";
               }
            }
            if ($ht == -0.85) {
               if ($datetime >= 20050105.0500 && $datetime <= 20050105.0500) {
                   $new_flag = "D";
               }
            }
            if ($ht == -1.75) {
               if ($datetime >= 20080913.0700 && $datetime <= 20080913.0700) {
                   $new_flag = "D";
               }
               if ($datetime >= 20080830.0700 && $datetime <= 20080830.0700) {
                   $new_flag = "D";
               }
               if ($datetime >= 20050105.0500 && $datetime <= 20050105.0500) {
                   $new_flag = "D";
            ...
            if ($ht == -0.35) {
               if ($datetime >= 20080913.0900 && $datetime <= 20080914.2000) {
                   $new_flag = "D";
               }
               if ($datetime >= 20050105.0500 && $datetime <= 20050105.0500) {
                   $new_flag = "D";
        ...
        if ($var eq "tsoil_W") {
            if ($ht == -0.15) {
               if ($datetime >= 20080830.0600 && $datetime <= 20091231.2300) {
                   $new_flag = "B";
               }
            }
            if ($ht == -1.75) {
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -0.05) {
               if ($datetime >= 20070211.0000 && $datetime <= 20070223.1600) {
                   $new_flag = "D";
               }
            }
            if ($ht == -0.60) {
               if ($datetime >= 20060530.1800 && $datetime <= 20060530.1800) {
                   $new_flag = "D";
               }
            }
            if ($ht == -0.35) {
               if ($datetime >= 20050210.1700 && $datetime <= 20050210.1700) {
                   $new_flag = "D";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -1.25) {
               if ($datetime >= 20050111.2000 && $datetime <= 20050111.2000) {
                   $new_flag = "D";
               }
            }
        }
    ...
    #---------------------------------------------------------------------------
        ...
        if ($var eq "watcont_W") {
            if ($ht == -1.25) {
               if ($datetime >= 20060623.0200 && $datetime <= 20060627.1700) {
                   $new_flag = "B";
               }
            }
            if ($ht == -0.60) {
            ...
            if ($ht == -0.15) {
               if ($datetime >= 20081110.2200 && $datetime <= 20081111.1400) {
                   $new_flag = "B";
               }
            }
        }
    ...
    if (($id eq "E1") || ($id eq "E2") || ($id eq "E3") || ($id eq "E4") || ($id eq "E5") || ($id eq "E6") || ($id eq "E7") || ($id eq "E10") || ($id eq "E12") || ($id eq "E15") || ($id eq "E16") || ($id eq "E19") || ($id eq "E20") || ($id eq "E22") || ($id eq "E27")) {
		$new_flag = "B" if ($new_flag eq "U");
	}
