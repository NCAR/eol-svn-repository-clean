...
# $file_in = "code_frag/SGP_SFC_more_flagging_2005_2009.txt";
 $file_in = "code_frag/SGP_FLX_flagging_2005_2009.txt";

#--------------------------------------------------------------------------------------
# the output file
#--------------------------------------------------------------------------------------
# $file_frag = "code_frag/add_more_Scots_sfc_flags_to_conversion_software.txt";
$file_frag = "code_frag/add_Scots_flx_flags_to_conversion_software.txt";
...
print "\nRunning $0\n";
	...
	#		   E26             soil              D      2005/12/20 09:00       2005/12/22 08:30
	#-------------------------------------------------------------------------------------------------------------
	...
	while ($this_line = <INFILE>) {
		if ($this_line =~ /(^[CE]\d{1,3}) +(\w+) +(\w) +(\d{4})\/(\d{2})\/(\d{2}) +(\d{4}) +(\d{4})\/(\d{2})\/(\d{2}) +(\d{4})/) { 
