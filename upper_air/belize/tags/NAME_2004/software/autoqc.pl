...
my $AUTOQC = "/work/software/NAME/library/upper_air/autoQC/bin/autoqc_NAME_5point_avg";

my $INPUT_DIR = "../new_avg7pt";
my $OUTPUT_DIR = "../new_avg7pt/final";
my $ERR_DIR = "../new_avg7pt/logs";
