...
##Module------------------------------------------------------------------------
# <p>The Pontianak_Radiosonde_Converter.pl script converts ASCII
...
#
##Module------------------------------------------------------------------------
package Pontianak_Radiosonde_Converter;
use strict;
...
printf "\nPontianak_Radiosonde_Converter.pl began on ";print scalar localtime;printf "\n\n";  
&main();
printf "\nPontianak_Radiosonde_Converter.pl ended on ";print scalar localtime;printf "\n";

##------------------------------------------------------------------------------
# @signature void main()
# <p>Process the Indonesia Site - Pontianak radiosonde sounding
# data by converting it from the native ASCII format into the ESC format.</p>
##------------------------------------------------------------------------------
sub main {
    my $converter = Pontianak_Radiosonde_Converter->new();
    $converter->convert();
}

##------------------------------------------------------------------------------
# @signature Pontianak_Radiosonde_Converter new()
# <p>Create a new instance of a Pontianak_Radiosonde_Converter.</p>
#
# @output $self A new Pontianak_Radiosonde_Converter object.
##------------------------------------------------------------------------------
sub new {
    my $invocant = shift;
    my $self = {};
...
sub buildDefaultStation {
    ...
    # HARD-CODED
    my $station = Station->new("Pontianak",$self->{"NETWORK"});
    
	$station->setStationName("Pontianak");
...
sub loadHeaderInfo {
    ...
    foreach my $headerFile (@files)
	{
        ...
        $header->setId("Pontianak");
	    # "Release Site Type/Site ID:" header line
        $header->setSite("Pontianak, Indonesia/96851");
