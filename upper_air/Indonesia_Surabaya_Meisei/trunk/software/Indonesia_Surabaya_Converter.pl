...
##Module------------------------------------------------------------------------
# <p>The Indonesia_Surabaya_Converter.pl script is used for converting 
# high resolution radiosonde data to the EOL Sounding Composite (ESC) format.
#
# @author L.E. Cully August/September 2012
# @version DYNAMO  Created to convert Indonesia Surabaya Sonde (Meisei) data.
...
#          times in the Surabaya data and to assume that every record is 
...
#            Indonesia_Surabaya_DYNAMO_sounding_stationCD.out station file to the
#            ../final directory.
...
#  Execute:
#
# @use     Indonesia_Surabaya_Converter.pl >& output.log
#
##Module------------------------------------------------------------------------
package Indonesia_Surabaya_Converter;
use strict;
...
printf "\nIndonesia_Surabaya_Converter.pl began on ";print scalar localtime;printf "\n";
my $debug = 0;
my $debug_bad_asc = 0;

&main();
printf "\nIndonesia_Surabaya_Converter.pl ended on ";print scalar localtime;printf "\n";
...
##------------------------------------------------------------------------------
# @signature void main()
# <p>Process the Indonesia Surabaya radiosonde data by converting it from 
# the native ASCII format into the ESC format.</p>
##------------------------------------------------------------------------------
sub main {
    my $converter = Indonesia_Surabaya_Converter->new();
    $converter->convert();
} # main()

##------------------------------------------------------------------------------
# @signature Indonesia_Surabaya_Converter new()
# <p>Create a new instance of a Indonesia_Surabaya_Converter.</p>
#
# @output $self A new Indonesia_Surabaya_Converter object.
##------------------------------------------------------------------------------
sub new {
    my $invocant = shift;
    my $self = {};
    ...
    # HARDCODED
    $self->{"PROJECT"} = "DYNAMO";
    $self->{"NETWORK"} = "Indonesia_Surabaya";
...
sub parseHeader {
    ...
    # line: "Data Type:  Indonesia_Surabaya/Ascending"
    #-------------------------------------------------
    ...
    #-------------------------------------------------
    $header->setId("Indonesia_Surabaya");        #HARDCODED

    #-------------------------------------------------
    # This info goes in the 
    # "Release Site Type/Site ID:" header line
    #-------------------------------------------------
    $header->setSite("Surabaya, Indonesia/96935");  #HARDCODED
