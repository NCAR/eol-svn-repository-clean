...
##Module------------------------------------------------------------------------
# <p>The Indonesia_Ambon_converter.pl script is used for converting 
# high resolution radiosonde data to the EOL Sounding Composite (ESC) format.
#
# @author L.E. Cully September 2012
# @version DYNAMO  Created to convert Indonesia Ambon Sonde (Meisei) data.
...
#          times in the Ambon data and to assume that every record is 
...
#
#          Note this site's local time is 9 hours off from UTC. That is, LT-9=UTC.
#
...
#            Ambon_DYNAMO_sounding_stationCD.out station file to the
#            ../final directory.
...
#  Execute:
#
# @use     Indonesia_Ambon_converter.pl >& output.log
#
##Module------------------------------------------------------------------------
package Indonesia_Ambon_converter;
use strict;
...
printf "\nIndonesia_Ambon_converter.pl began on ";print scalar localtime;printf "\n";
my $debug = 0;
my $debug_bad_asc = 0;

&main();
printf "\nIndonesia_Ambon_converter.pl ended on ";print scalar localtime;printf "\n";
...
##------------------------------------------------------------------------------
# @signature void main()
# <p>Process the Indonesia Ambon radiosonde data by converting it from 
# the native ASCII format into the ESC format.</p>
##------------------------------------------------------------------------------
sub main {
    my $converter = Indonesia_Ambon_converter->new();
    $converter->convert();
} # main()

##------------------------------------------------------------------------------
# @signature Indonesia_Ambon_converter new()
# <p>Create a new instance of a Indonesia_Ambon_converter.</p>
#
# @output $self A new Indonesia_Ambon_converter object.
##------------------------------------------------------------------------------
sub new {
    my $invocant = shift;
    my $self = {};
...
sub parseHeader {
    ...
    # line: "Data Type:  Ambon/Ascending"
    #-------------------------------------------------
    ...
    #-------------------------------------------------
    $header->setId("Indonesia_Ambon");        #HARDCODED

    #-------------------------------------------------
    # This info goes in the 
    # "Release Site Type/Site ID:" header line
    #-------------------------------------------------
    $header->setSite("Ambon, Indonesia/97724");  #HARDCODED
