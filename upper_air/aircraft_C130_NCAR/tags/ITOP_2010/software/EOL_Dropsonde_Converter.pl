...
sub readRawFile {
    ...
    # RAW: Project Name/Platform:     10082217307 WXWXW TESTA, 10082217307 WXWXW TESTA/Lockheed C-130J, - 98005307 -
	# some headers have AF307 included:
    # 10092413307 AF307 0422W MALAKAS, 10092413307 AF307 0422W MALAKAS/Lockheed C-130J, - 98005307 -
	...
	if ($flight =~ /AF30[47]/)
	{
		print "\tFLIGHT BEFORE TRIM: $flight\n";
		$flight =~ s/AF30[47]\s//g;
	    print "\tFLIGHT: $flight\n";
	}
    $stn_id = trim($stn_id);
    $stn_id =~ s/-//g;
	...
	{
		print "WARN: Unknown station id - not AF304 or AF307\n";
	}
