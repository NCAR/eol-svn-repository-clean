...
use strict;
use lib "/work/software/RICO/library/conversion_modules/Version3";
...
sub getNetworkName { return "Dropsonde"; }
...
sub readRawFile {
    ...
    my (undef(),$flight) = split(' ',(split(/:/,<$FILE>))[1]);
...
#    die();
	...
	$station = Station::Station->new($stn_id,getNetworkName());
