RICO San Juan, Puerto Rico High Resolution Rawinsonde (6-sec vertical levels) Data


1.0  General Description


     This is one of the upper air data sets developed for the Rain in
Cumulus Over the Ocean (RICO) project.  This data set includes 126 high
vertical resolution (6-second) soundings from the San Juan, Puerto Rico
National Weather Service (NWS) rawinsonde station (WMO 78526) for the period
01 December 2004 to 31 January 2005. The soundings were typically released
twice a day (0000 and 1200 UTC).
...
Sample Data
     ...
     The following is a sample record of RICO Sounding Rawinsonde NWS
...
Project ID:                        0
Release Site Type/Site ID:         SJU San Juan, PR
Release Location (lon,lat,alt):    66 00.00'W, 18 24.00'N,  -66.0,  18.4,    3.0
UTC Release Time (y,m,d,h,m,s):    2004, 11, 30, 23:07:00
Ascension No:                      1688
Radiosonde Serial Number:          84940205.CSN
Radiosonde Manufacturer:           VIZ B2
/
/
/
Nominal Release Time (y,m,d,h,m,s):2004, 12, 01, 00:00:00
...
------ ------ ----- ----- ----- ------ ------ ----- ----- ----- -------- ------- ----- ----- ------- ---- ---- ---- ---- ---- ----
   0.0 1013.5  24.5  18.7  70.0   -0.9   -2.4   2.6  20.6 999.0  -66.000  18.400 999.0 999.0     3.0 99.0 99.0 99.0 99.0 99.0  9.0
   6.0 1010.2  24.8  19.7  73.5   -0.9   -2.6   2.8  19.1   4.8 9999.000 999.000 999.0 999.0    32.0 99.0 99.0 99.0  4.0  4.0 99.0
  12.0 1006.6  24.9  19.8  73.2   -0.8   -2.7   2.8  16.5   5.2 9999.000 999.000 999.0 999.0    63.0 99.0 99.0 99.0  4.0  4.0 99.0
  18.0 1003.4  24.7  19.6  73.1   -0.8   -2.9   3.0  15.4   4.7 9999.000 999.000 999.0 999.0    91.0 99.0 99.0 99.0  4.0  4.0 99.0
  24.0 1000.4  24.4  19.3  73.2   -0.7   -3.1   3.2  12.7   4.3 9999.000 999.000 999.0 999.0   117.0 99.0 99.0 99.0  4.0  4.0 99.0
  30.0  997.2  24.2  19.1  73.3   -0.7   -3.2   3.3  12.3   4.8  -66.001  18.399  38.5  29.7   146.0 99.0 99.0 99.0  4.0  4.0 99.0

2.2  Data Remarks

     NWS soundings during RICO utilized the VIZ type radiosonde
...
ID   SITE            COUNTRY    LONG     LAT   ELEV (m) SONDE TYPE
------------------------------------------------------------------
SJU San Juan             PR    -66.0    18.0      3.0    VIZ B1
...
checks on the RICO NWS sounding dataset.  In the table P = pressure, T =
