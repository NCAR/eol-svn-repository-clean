...
1.0  General Description
     ...
     This is one of the upper air data sets developed for the Cumulus
Photogrammetric, In-Situ and Doppler Observations (CuPIDO) project.  This data
set includes 631 high vertical resolution (6-second) soundings from 5 National
Weather Service (NWS) rawinsonde stations in the southwest United States and 378
high vertical resolution (1-second) soundings from the 3 NWS rawinsonde stations
in the southwest United States for the period 01 July to 31 August 2007.  The
soundings were typically released twice a day (0000 and 1200 UTC).  This data
...
-------------------------------------------------------------------------
ABQ Albuquerque        NM     US     -106.6    35.0   1615.0
AMA Amarillo           TX     US     -101.7    35.2   1094.0
DRT Del Rio            TX     US     -100.9    29.4    314.0
EPZ Santa Teresa       NM     US     -106.7    31.9   1252.0
FGZ Flagstaff          AZ     US     -111.8    35.2   2179.0
MAF Midland            TX     US     -102.2    31.9    873.0
NKX San Diego          CA     US     -117.1    32.8    134.0
TUS Tucson             AZ     US     -110.9    32.1    787.0

Note that Amarillo, Flagstaff, and Midland used the Radiosonde Replacement System 
