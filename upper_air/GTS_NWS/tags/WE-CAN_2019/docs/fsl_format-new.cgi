...
<html><head>
<title>FSL Output Format</title>
</head>
<body>

<center>
<h1>FSL Output Format Description</h1>
<h3>(FSL Radiosonde Database)</h3>
</center>
<HR>
<basefont size="3">
<pre>
...
applicable.
 ...
 LINTYP
    ...
    254        HOUR        DAY      MONTH       YEAR    (blank)     (blank)
      1       WBAN#       WMO#        LAT <B>D</B>      LON <B>D</B>     ELEV       RTIME
...
<B>Note the format descriptor for LINTYP=1 has changed to conform with the 
CDROM archive.</B>
...
<hr>
<basefont size="4">
<a href="../Welcome.cgi">Begin RAOB database request</a>
<p>
<basefont size="2">
<em>Prepared by <strong>Mark Govett</strong>,
        <a href="mailto:Mark.W.Govett@noaa.gov">Mark.W.Govett@noaa.gov</a>,
        ; and <strong>Bill Moninger</strong>
        <a href="mailto: William.R.Moninger@noaa.gov"> William.R.Moninger@noaa.gov</a>
        </em>
