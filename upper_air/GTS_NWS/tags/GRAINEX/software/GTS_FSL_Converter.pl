...
#
# @author Alley Robinson 24 October 2018
# @version GRAINEX
# 		- Updated the code to be compatible with the GRAINEX data files
#		- There are two stations in a single file
