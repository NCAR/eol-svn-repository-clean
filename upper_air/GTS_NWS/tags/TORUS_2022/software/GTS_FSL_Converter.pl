...
#
#
# @author Linda Echo-Hawk  14 July 2022
# @version TORUS_2022
#      - to convert GTS messages from KOUN, KTOP and KDNR to ESC
#        format (raob_soundings63655.tmp.txt).
#      - Search for "HARD-CODED" to change project related constants.
#
# @author Linda Cully 17 May 2022
# @version CHEESEHEAD
#      - to convert GTS messages from KDVN to ESC
#        format (raob_soundings64792.tmp.txt).
#      - Search for "HARD-CODED" to change project related constants.
#
# @author Linda Echo-Hawk 28 June 2019
# @version TORUS_2019
#      - to convert GTS messages from KOUN, KTOP and KDNR to ESC
#        format (raob_soundings63655.tmp.txt).
#      - Search for "HARD-CODED" to change project related constants.
#
# @author Linda Echo-Hawk 6 June 2019
# @version Meso18-19 (VORTEX-SE)
#      - to convert GTS messages (raob_soundings19038.tmp.txt) to ESC format
#      - Search for "HARD-CODED" to change project related constants.
#
# @author Linda Echo-Hawk 4 June 2019
# @version WE-CAN 2018
#      - to convert GTS messages from KDNR to ESC format
#      - Search for "HARD-CODED" to change project related constants.
#
# @author Linda Echo-Hawk 3 June 2019
# @version ICICLE 2019
#      - to convert GTS messages from KDVN and KTOP to ESC format
#      - Search for "HARD-CODED" to change project related constants.
#
#
...
sub new {
    ...
    # ----------------------------------
    $self->{"PROJECT"} = "TORUS_2022"; 
    # $self->{"NETWORK"} = "2018_FL_CA_HI_MX_GTS";
    # $self->{"NETWORK"} = "RAOB_64792_GTS";
    $self->{"NETWORK"} = "KDNR_KOUN_KTOP";
