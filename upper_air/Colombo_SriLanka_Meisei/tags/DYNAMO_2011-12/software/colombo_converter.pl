...
##Module------------------------------------------------------------------------
# <p>The Colombo_Converter.pl script is used for converting 
# high resolution radiosonde data to the EOL Sounding Composite (ESC) format.
#
# @author L.E. Cully August/September 2012
# @version DYNAMO  Created to convert Indonesia Colombo Sonde (Meisei) data.
...
#          times in the Colombo data and to assume that every record is 
...
#            Colombo_DYNAMO_sounding_stationCD.out station file to the
#            ../final directory.
...
#  Execute:
#
# @use     Colombo_Converter.pl >& output.log
#
##Module------------------------------------------------------------------------
package Colombo_Converter;
use strict;
...
printf "\nColombo_Converter.pl began on ";print scalar localtime;printf "\n";
my $debug = 0;
my $debug_bad_asc = 0;

&main();
printf "\nColombo_Converter.pl ended on ";print scalar localtime;printf "\n";
...
##------------------------------------------------------------------------------
# @signature void main()
# <p>Process the Indonesia Colombo radiosonde data by converting it from 
# the native ASCII format into the ESC format.</p>
##------------------------------------------------------------------------------
sub main {
    my $converter = Colombo_Converter->new();
    $converter->convert();
} # main()

##------------------------------------------------------------------------------
# @signature Colombo_Converter new()
# <p>Create a new instance of a Colombo_Converter.</p>
#
# @output $self A new Colombo_Converter object.
##------------------------------------------------------------------------------
sub new {
    my $invocant = shift;
    my $self = {};
...
sub parseHeader {
    ...
    # line: "Data Type:  Colombo/Ascending"
    #-------------------------------------------------
    $header->setType("DMSL Radiosonde");         #HARDCODED
    $header->setReleaseDirection("Ascending");   #HARDCODED
    ...
    #-------------------------------------------------
    $header->setId("Colombo");        #HARDCODED

    #-------------------------------------------------
    # This info goes in the 
    # "Release Site Type/Site ID:" header line
    #-------------------------------------------------
    $header->setSite("Colombo, Sri Lanka/43466");  #HARDCODED
