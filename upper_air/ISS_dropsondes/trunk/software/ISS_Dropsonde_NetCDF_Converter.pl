...
#
##Module-------------------------------------------------------------------------
# <p>The ISS_Dropsonde_NetCDF_Converter.pl script is used for converting 
...
printf "\nISS_Dropsonde_NetCDF_Converter.pl began on ";print scalar localtime;printf "\n";
