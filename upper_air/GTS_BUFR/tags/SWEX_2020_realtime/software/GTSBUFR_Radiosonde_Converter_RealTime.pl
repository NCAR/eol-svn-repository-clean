...
#
# Mar 2022 - LEC Updated s/w to rename two site names and the coordinates of another
#    per the data source request. Here are the changes: Rename SB Fire Station 18
#    to SB Fire Station 38. Rename Lake Cachuma site (ISS2) to be Rancho Alegre
#    with new coordinates of 34.56306, -119.95028.
#
##Module------------------------------------------------------------------------
...
#        $site = "SB_Fire_Station_18";
     ...
     elsif (index(lc($file), "sbfs38") != -1)  # HERE New 2022
        {
        $site = "SantaBarbara_Fire_Stn38";
        $country = "USA";
        $messageID = "IUSB04";
        }
#     elsif (index(lc($file), "iss2") != -1)   # HERE Name change for 2022. See next elsif.
#        {
...
#        }
        ...
        {
        $site = "NCAR_ISS2_Rancho_Alegre";
        $country = "USA";
        $messageID = "IUSB02";
        }
     elsif (index(lc($file), "iss3") != -1)
        {
#        $site = "NCAR_ISS3_UCSB_Sedgwick_CA";
#        $site = "ISS3_UCSB_Sedgwick";
        $site = "NCAR_ISS3_UCSB_Sedgwick";
        $country = "USA";
        $messageID = "IUSB03";
        }
     else
...
#        $site = "Santa Barbara Fire Station 18";
     ...
     elsif (index(lc($file), "sbfs38") != -1) # HERE New Mar 2022
        {
        $site = "SBFS38";
        }
#     elsif (index(lc($file), "iss2") != -1)   # HERE Was prior to Mar 2022
#        {
##        $site = "NCAR_ISS2_Lake_Cachuma_Camp_CA";
#        $site = "Lake_Cachuma";
#        }
     elsif (index(lc($file), "iss2") != -1)  # HERE New Mar 2022
        {
        $site = "Rancho_Alegre";
        }
     elsif (index(lc($file), "iss3") != -1)
