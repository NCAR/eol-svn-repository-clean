Steps for Converting *.bfr Files to Sorted *.cls Files to Plot   - Updated 19 Jul 2019 LEC
--------------------------------------------------------------
...
1. Convert BUFR to Readable ASCII:
  preprocess_GTS_BUFR.pl ../raw_gts_bufr_data ../output_ascii_data ../output_preproc_data >& preproc_OTREC.log &



2. Convert Readable ASCII to ESC (*.cls) format:
  GTSBUFR_Radiosonde_Converter_RealTime.pl  OTREC ../output_preproc_data ../output_esc 0 >& runOTREC_rt.log & 
...
See Janet Scannell's software in SVN.
