...
1. Convert BUFR to Readable ASCII:
  preprocess_GTS_BUFR.pl ../raw_gts_bufr_data ../output_ascii_data ../output_preproc_data >& preproc_SWEX.log &



2. Convert Readable ASCII to ESC (*.cls) format:
  GTSBUFR_Radiosonde_Converter_RealTime.pl  SWEX ../output_preproc_data ../output_esc 0 >& runSWEX_rt.log & 
