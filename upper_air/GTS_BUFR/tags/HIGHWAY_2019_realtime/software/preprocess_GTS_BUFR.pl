...
# software. Changes were made for the HIGHWAY 2019 project data which has *.bufr
# files instead of *.bfr as seen for OTREC 2019. 
#
# 11 July 2019 - LEC
# WARNING: This code has been slightly modified from the non-realtime processing
...
#
# 7. REALTIME MOD - That incoming raw bufr data files have suffix of .bfr for OTREC 2019
#    but updated to process *.bufr files for HIGHWAY 2019 project. 
#
# Created: L. Cully Sept 2018
#
# Updates:
# August 2019 - Slight mods for REALTIME processing. Expect incoming BUFR files
#    to have suffix of "bufr" for HIGHWAY 2019 project. For OTREC 2019, *.bfr
#    files were expected. 
#
...
sub main 
   ...
   # Changed for realtime processing from *.bfr to *.bufr for HIGHWAY..
   #----------------------------------------------------------------
   ...
   # Changed for realtime processing from *.bfr. For HIGHWAY, reset
   # to *.bufr.
   #----------------------------------------------------------------
