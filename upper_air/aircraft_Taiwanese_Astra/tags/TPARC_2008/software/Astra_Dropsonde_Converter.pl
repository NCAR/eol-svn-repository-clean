...
##Module----------------------------------------------------------------------------
# <p>The Astra_Dropsonde_Converter converts data from the Astra Aircraft into the
# ESC format.</p>
#
...
sub getNetworkName { return "Astra"; }
...
sub readRawFile {
    ...
    # Project Name/Platform:                     Jangmi, 733/ASTRA SPx, B20001 
	my ($planeInfo, $stn_id) = (split(',',(split(/:/,<$FILE>))[1]))[1..2];
	# RETURNS $planeInfo = 733/ASTRA SPx, $stn_id = B20001
    ...
    #  Launch Location (lon,lat,alt):             126 44.56'E 126.742744, 24 50.24'N 24.837341, 13107.61 
    ...
    # UTC Launch Time (y,m,d,h,m,s):             2008, 09, 28, 00:45:54   
    ...
    # Reference Launch Data Source/Time:         - none -/00:00:34.74    
...
#-------------------------------------------   
    ...
    # need new CODIAC platform number "389, Aircraft, Taiwanese Astra"
