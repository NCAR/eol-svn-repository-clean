...
# follows (*Variables that are only available from soundings launched from Trois-Rivi√®res:
#
...
# WSpeed: The wind speed measured by the radiosonde in m s^(-1)
...
#
# 0.0 1005.65 +3.80 64.20 1.2 203 0.0 073‚08.967'W    45‚32.096'N
#
