...
sub parseHeader {
	...
	# Note for VOCALS, Scot requested Iquique location be used
    # since header info was merely release date
    # my ($site) = (split(/:/,$lines[3]))[1];
	my $site = "Iquique, Chile";
    # HARD-CODED
    $header->setId("Iquique_GAUS");
