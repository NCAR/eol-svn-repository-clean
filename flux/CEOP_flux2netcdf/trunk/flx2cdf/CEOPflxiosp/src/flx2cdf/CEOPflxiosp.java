 ...
 * 
 * This program reads the CEOP Flux Dataset data
 ...
 */
public class CEOPflxiosp extends AbstractIOServiceProvider {
...
/**
 * Determine quickly whether the input file is of the CEOP flux type.  This
...
// flag is true if missing height (-999.99) is contained in file.
   private boolean missingHeight;
 ...
 *
 * @param infile - CEOP flux input data file
 * @param ncfile - CEOP flux output netCDF file
 ...
 */
   ...
   public void open(RandomAccessFile infile, NetcdfFile ncfile, CancelTask cancelTask)
      ...
      try {
         ...
         e.printStackTrace();
         throw new IOException("CEOPflxiosp: Parse exception occured.");
      } catch (ConversionException e) {
         e.printStackTrace();
         throw new IOException("CEOPflxiosp: Invalid conversion attempted.");
      }
   }
...
// Create output netCDF file name and add the name to the list of filenames created.
      ...
      outfilename = rhp + "_" + rsi + "_" + station + "_flx.nc";
      if (outdirname != null) {
...
// Create global attributes for the netCDF file.
      ...
      ncfile.addAttribute(null, new Attribute("Data_Type", "flx"));
      ncfile.addAttribute(null, new Attribute("Data_Type_Long_Name", "Flux"));
...
// Create all the variables in the netCDF file.
      ...
      if (missingHeight) {
         height.addAttribute(new Attribute("height_comment",
            "A height value of -999.99 means the height is missing since instruments at multiple heights were used to derive the flux values."));
      }
      ...
      Variable sens = new Variable(ncfile, null, null, "surface_upward_sensible_heat_flux");
      sens.setDimensions("time height");
      sens.setDataType(DataType.DOUBLE);
      sens.addAttribute(new Attribute("standard_name", "surface_upward_sensible_heat_flux"));
      sens.addAttribute(new Attribute("long_name", "Sensible Heat Flux"));
      sens.addAttribute(new Attribute("units", "W/m2"));
      sens.addAttribute(new Attribute("coordinates", "time longitude latitude altitude height"));
      sens.addAttribute(new Attribute("ancillary_variables", "surface_upward_sensible_heat_flux_flag"));
      sens.addAttribute(new Attribute("_FillValue", fillValue));
      sens.addAttribute(new Attribute("missing_value", fillValue));
      sens.setCachedData(sensArray, false);
      ncfile.addVariable(null, sens);
      Variable sflag = new Variable(ncfile, null, null, "surface_upward_sensible_heat_flux_flag");
      sflag.setDimensions("time height");
      sflag.setDataType(DataType.CHAR);
      sflag.addAttribute(new Attribute("standard_name", "surface_upward_sensible_heat_flux status_flag"));
      sflag.addAttribute(new Attribute("long_name", "Sensible Heat Flux Flag"));
      ...
      sflag.addAttribute(new Attribute("coordinates", "time longitude latitude altitude height"));
      sflag.addAttribute(new Attribute("_FillValue", "M"));
      sflag.addAttribute(new Attribute("missing_value", "M"));
      sflag.setCachedData(sflagArray, false);
      ncfile.addVariable(null, sflag);
      Variable latent = new Variable(ncfile, null, null, "surface_upward_latent_heat_flux");
      latent.setDimensions("time height");
      latent.setDataType(DataType.DOUBLE);
      latent.addAttribute(new Attribute("standard_name", "surface_upward_latent_heat_flux"));
      latent.addAttribute(new Attribute("long_name", "Latent Heat Flux"));
      latent.addAttribute(new Attribute("units", "W/m2"));
      latent.addAttribute(new Attribute("coordinates", "time longitude latitude altitude height"));
      latent.addAttribute(new Attribute("ancillary_variables", "surface_upward_latent_heat_flux_flag"));
      latent.addAttribute(new Attribute("_FillValue", fillValue));
      latent.addAttribute(new Attribute("missing_value", fillValue));
      latent.setCachedData(latentArray, false);
      ncfile.addVariable(null, latent);
      Variable lflag = new Variable(ncfile, null, null, "surface_upward_latent_heat_flux_flag");
      lflag.setDimensions("time height");
      lflag.setDataType(DataType.CHAR);
      lflag.addAttribute(new Attribute("standard_name", "surface_upward_latent_heat_flux status_flag"));
      lflag.addAttribute(new Attribute("long_name", "Latent Heat Flux Flag"));
      lflag.addAttribute(new Attribute("flag_values", "C M B I D G U"));
      lflag.addAttribute(new Attribute("flag_meanings",
            "exceeds_field_size missing bad interpolated_or_estimated_or_gap_filled questionable good unchecked"));
      lflag.addAttribute(new Attribute("coordinates", "time longitude latitude altitude height"));
      lflag.addAttribute(new Attribute("_FillValue", "M"));
      lflag.addAttribute(new Attribute("missing_value", "M"));
      lflag.setCachedData(lflagArray, false);
      ncfile.addVariable(null, lflag);
      Variable co2 = new Variable(ncfile, null, null, "surface_carbon_dioxide_mole_flux");
      co2.setDimensions("time height");
      co2.setDataType(DataType.DOUBLE);
      co2.addAttribute(new Attribute("standard_name", "surface_carbon_dioxide_mole_flux"));
      co2.addAttribute(new Attribute("long_name", "CO2 Flux"));
      co2.addAttribute(new Attribute("units", "mol/m2/s"));
      co2.addAttribute(new Attribute("coordinates", "time longitude latitude altitude height"));
      co2.addAttribute(new Attribute("ancillary_variables", "surface_carbon_dioxide_mole_flux_flag"));
      co2.addAttribute(new Attribute("_FillValue", fillValue));
      co2.addAttribute(new Attribute("missing_value", fillValue));
      co2.setCachedData(co2Array, false);
      ncfile.addVariable(null, co2);
      Variable cflag = new Variable(ncfile, null, null, "surface_carbon_dioxide_mole_flux_flag");
      cflag.setDimensions("time height");
      cflag.setDataType(DataType.CHAR);
      cflag.addAttribute(new Attribute("standard_name", "surface_carbon_dioxide_mole_flux status_flag"));
      cflag.addAttribute(new Attribute("long_name", "CO2 Flux Flag"));
      cflag.addAttribute(new Attribute("flag_values", "C M B I D G U"));
      cflag.addAttribute(new Attribute("flag_meanings",
            "exceeds_field_size missing bad interpolated_or_estimated_or_gap_filled questionable good unchecked"));
      cflag.addAttribute(new Attribute("coordinates", "time longitude latitude altitude height"));
      cflag.addAttribute(new Attribute("_FillValue", "M"));
      cflag.addAttribute(new Attribute("missing_value", "M"));
      cflag.setCachedData(cflagArray, false);
      ncfile.addVariable(null, cflag);
      Variable soil = new Variable(ncfile, null, null, "downward_heat_flux_in_soil");
      soil.setDimensions("time height");
      soil.setDataType(DataType.DOUBLE);
      soil.addAttribute(new Attribute("standard_name", "downward_heat_flux_in_soil"));
      soil.addAttribute(new Attribute("long_name", "Soil Heat Flux"));
      soil.addAttribute(new Attribute("units", "W/m2"));
      soil.addAttribute(new Attribute("coordinates", "time longitude latitude altitude height"));
      soil.addAttribute(new Attribute("ancillary_variables", "downward_heat_flux_in_soil_flag"));
      soil.addAttribute(new Attribute("_FillValue", fillValue));
      soil.addAttribute(new Attribute("missing_value", fillValue));
      soil.setCachedData(soilArray, false);
      ncfile.addVariable(null, soil);
      Variable soilflag = new Variable(ncfile, null, null, "downward_heat_flux_in_soil_flag");
      soilflag.setDimensions("time height");
      soilflag.setDataType(DataType.CHAR);
      soilflag.addAttribute(new Attribute("standard_name", "downward_heat_flux_in_soil status_flag"));
      soilflag.addAttribute(new Attribute("long_name", "Soil Heat Flux Flag"));
      soilflag.addAttribute(new Attribute("flag_values", "C M B I D G U"));
      soilflag.addAttribute(new Attribute("flag_meanings",
            "exceeds_field_size missing bad interpolated_or_estimated_or_gap_filled questionable good unchecked"));
      soilflag.addAttribute(new Attribute("coordinates", "time longitude latitude altitude height"));
      soilflag.addAttribute(new Attribute("_FillValue", "M"));
      soilflag.addAttribute(new Attribute("missing_value", "M"));
      soilflag.setCachedData(soilflagArray, false);
      ncfile.addVariable(null, soilflag);
...
// Sort heights in ascending order.
         try {
            Collections.sort(sensorHeight);
              ...
              e.printStackTrace();
              throw new IOException("CEOPflxiosp: Class cast exception in sorting heights array.");
         } catch (UnsupportedOperationException e) {
              e.printStackTrace();
              throw new IOException("CEOPflxiosp: Unsupported operation exception in sorting heights array.");
         }
...
// Set size of data arrays.
         ...
         sensArray = (ArrayDouble.D2) Array.factory(DataType.DOUBLE, shape);
         sflagArray = (ArrayChar.D2) Array.factory(DataType.CHAR, shape);
         latentArray = (ArrayDouble.D2) Array.factory(DataType.DOUBLE, shape);
         lflagArray = (ArrayChar.D2) Array.factory(DataType.CHAR, shape);
         co2Array = (ArrayDouble.D2) Array.factory(DataType.DOUBLE, shape);
         cflagArray = (ArrayChar.D2) Array.factory(DataType.CHAR, shape);
         soilArray = (ArrayDouble.D2) Array.factory(DataType.DOUBLE, shape);
         soilflagArray = (ArrayChar.D2) Array.factory(DataType.CHAR, shape);
...
// one time for each set of heights.
                  sensArray.set(i, j, fillValue);
                  sflagArray.set(i, j, charFill);
                  latentArray.set(i, j, fillValue);
                  lflagArray.set(i, j, charFill);
                  co2Array.set(i, j, fillValue);
                  cflagArray.set(i, j, charFill);
                  soilArray.set(i, j, fillValue);
                  soilflagArray.set(i, j, charFill);
               } else {
...
// one time for each set of heights.
                     ...
                     sensArray.set(i, j, var);
                     sflagArray.set(i, j, data[12].charAt(0));
                     if (data[13].contains("-0.00")) {
                        var = Double.parseDouble("0.00");
                     } else {
                        var = Double.parseDouble(data[13]);
                     }
                     latentArray.set(i, j, var);
                     lflagArray.set(i, j, data[14].charAt(0));
                     ...
                     co2Array.set(i, j, var);
                     cflagArray.set(i, j, data[16].charAt(0));
                     if (data[17].contains("-0.00")) {
                        var = Double.parseDouble("0.00");
                     } else {
                        var = Double.parseDouble(data[17]);
                     }
                     soilArray.set(i, j, var);
                     soilflagArray.set(i, j, data[18].charAt(0));
                     recordpos++;
                  }
               }
            }
...
// reset file pointer to position before start of new station.
   ...
   public String getFileTypeDescription() {
      return("CEOP Flux Observation Data");
   }
   ...
   protected static void usage(int ret) {
      System.err.println("usage: CEOPflxiosp\n" +
...
//Parse arguments on command line.      
      Getopt g = new Getopt("CEOPflxiosp", args, "i:o:");
      ...
      ucar.nc2.NetcdfFile.registerIOProvider(CEOPflxiosp.class);
...
// incorrect message.       
         throw new IOException("ERROR: Input file " + infilename + " is not a valid CEOP flx file.");
      } finally {
         if (ncfile != null) {
            ncfile.close();
         }
